// copy with small modifications from https://github.com/lukechampine/lthash
...
// Add hash directly
func (h *hash16) AddHash(p *[2048]byte) {
	add16(&h.sum, p)
}

// Remove hash directly
func (h *hash16) RemoveHash(p *[2048]byte) {
	sub16(&h.sum, p)
}
